  ...
  ArrayList<LinkedList<Pair<Integer,Integer>>> lista;
	...
	*/
	public ArrayList<Integer> getSuccessors(int vertex) {
            ...
            for (Pair<Integer,Integer> a : lista.get(vertex))
                sucessors.add(a.getKey());
            return sucessors;
	}
	...
	*/	
	public int getWeight(int source, int destination) {
            LinkedList<Pair<Integer,Integer>> parejas = lista.get(source);
            for (Pair<Integer,Integer> a : parejas)
                if (a.getKey() == destination)
                    return a.getValue();
            return 0;
	}
}